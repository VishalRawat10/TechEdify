...
export default function ContactPage() {
  ...
  return (
    <section className="min-h-screen bg-light dark:bg-dark p-6 flex flex-col items-center">
      <div className="max-w-5xl w-full bg-light-card dark:bg-dark-card rounded-2xl shadow-md p-8 mt-10">
        ...
        >
          <div className="col-span-2 md:col-span-1 flex flex-col">
            ...
            <input
              ...
              className="px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder:text-light-secondary dark:placeholder:text-dark-secondary"
